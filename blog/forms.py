...
class FormulaireForm(ModelForm):
    ...
    class Meta:
        model = Formulaire
        fields = ['nom','ville','quartier','matiere','commune','cv','experience','niveau','telephone','photopi','phOto']
        widgets = {
            ...
            'matiere': TextInput(attrs={'placeholder':'Quelle matiere ?','class':'form-control'}),
            ...
            'niveau': TextInput(attrs={ 'placeholder':'niveau ?','class':'form-control'}),
